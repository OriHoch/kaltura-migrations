...
class Kaltura_Client_Type_StorageProfile extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null)
	{
		...
		$this->deliveryHttpsBaseUrl = (string)$xml->deliveryHttpsBaseUrl;
		...
		if(empty($xml->urlManagerParams))
			...
			$this->urlManagerParams = Kaltura_Client_ParseUtils::unmarshalArray($xml->urlManagerParams, "KalturaKeyValue");
